...
interface PoolTokenInterface extends Interface {
  functions: {
...
export class PoolToken extends Contract {
  connect(signerOrProvider: Signer | Provider | string): PoolToken;
  attach(addressOrName: string): PoolToken;
  deployed(): Promise<PoolToken>;

  on(event: EventFilter | string, listener: Listener): PoolToken;
  once(event: EventFilter | string, listener: Listener): PoolToken;
  addListener(eventName: EventFilter | string, listener: Listener): PoolToken;
  removeAllListeners(eventName: EventFilter | string): PoolToken;
  removeListener(eventName: any, listener: Listener): PoolToken;
